...
import static android.media.AudioAttributes.CONTENT_TYPE_MOVIE;
...
import com.gowtham.library.FileUtils;
...
//                String path=FileUtils.getRealPath(ActVideoTrimmer.this,Uri.fromFile(new File(uri.getPath())));
                FileUtils fu = new FileUtils(ActVideoTrimmer.this);
                String path= fu.getPath(Uri.fromFile(new File(uri.getPath())));
                uri = Uri.parse(path);
                runOnUiThread(() -> {
